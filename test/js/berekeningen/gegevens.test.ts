...
const personenJson: PersoonType[] = [{leeftijd: LeeftijdType.V}, {leeftijd: LeeftijdType.V, bruto_inkomen:10000}, {leeftijd: LeeftijdType.K611}];

const grafiekQuery: string = "2000;jaar;1,2;p;4;12345";
const grafiekJson: GrafiekType = { jaar: 2000, periode: PeriodeType.JAAR, van_tot: [1, 2], svt:SalarisVerhogingType.P, sv_p:4, sv_abs:1000, arbeidsInkomen: 12345};
